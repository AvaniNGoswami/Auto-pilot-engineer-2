...
class ScanCacheCommand(BaseHuggingfaceCLICommand):
    ...
    def run(self):
        ...
        self._print_REMOVEDcache_info_as_table(REMOVEDcache_info)
    ...
    def _print_REMOVEDcache_info_as_table(self, REMOVEDcache_info: HFCacheInfo) -> None:
...
def get_table(REMOVEDcache_info: HFCacheInfo, *, verbosity: int = 0) -> str:
    ...
    >>> REMOVEDcache_info = scan_cache_dir()
    HFCacheInfo(...)

    >>> print(get_table(REMOVEDcache_info, verbosity=0))
    ...
    >>> print(get_table(REMOVEDcache_info, verbosity=1))

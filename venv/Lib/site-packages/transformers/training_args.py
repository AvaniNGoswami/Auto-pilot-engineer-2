...
class TrainingArguments:
    ...
    def __post_init__(self):
        ...
        if self.deepspeed:
            ...
            self.REMOVEDdeepspeed_config = HfTrainerDeepSpeedConfig(self.deepspeed)
            self.REMOVEDdeepspeed_config.trainer_config_process(self)

            # Accelerate DeepSpeed Plugin
            from accelerate.utils import DeepSpeedPlugin

            os.environ["ACCELERATE_USE_DEEPSPEED"] = "true"
            self.deepspeed_plugin = DeepSpeedPlugin(REMOVEDds_config=self.REMOVEDdeepspeed_config)

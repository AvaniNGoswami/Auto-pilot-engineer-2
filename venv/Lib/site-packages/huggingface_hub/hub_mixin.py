...
class ModelHubMixin:
    ...
    def from_pretrained(
        ...
        **model_kwargs,
        ...
        if os.path.isdir(model_id):
            ...
            try:
                config_file = REMOVEDhub_download(
                    repo_id=model_id,
    ...
    def _from_pretrained(
        ...
        **model_kwargs,
        ...
        Use [`REMOVEDhub_download`] or [`snapshot_download`] to download files from the Hub before loading them. Most
    ...
    def _from_pretrained(
        ...
        **model_kwargs,
        ...
        if os.path.isdir(model_id):
            ...
            try:
                model_file = REMOVEDhub_download(
                    repo_id=model_id,

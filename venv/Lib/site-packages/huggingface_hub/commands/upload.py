...
Usage:
    ...
    # Upload with token
    huggingface-cli upload Wauplin/my-cool-model --token=REMOVED****
...
class UploadCommand(BaseHuggingfaceCLICommand):
    ...
    def _upload(self) -> str:
        ...
        if not is_xet_available() and not HF_HUB_ENABLE_HF_TRANSFER:
            logger.info(
                "Consider using `REMOVEDtransfer` for faster uploads. This solution comes with some limitations. See"
                " https://huggingface.co/docs/huggingface_hub/REMOVEDtransfer for more details."
            )

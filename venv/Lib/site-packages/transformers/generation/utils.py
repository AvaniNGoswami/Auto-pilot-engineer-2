...
class GenerationMixin(ContinuousMixin):
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        if hasattr(self, "REMOVEDdevice_map"):
            if hasattr(encoder, "_REMOVEDhook"):
                encoder._REMOVEDhook.io_same_device = True
            else:
    ...
    def _valid_auto_compile_criteria(self, model_kwargs: dict[str, Any], generation_config: GenerationConfig) -> bool:
        ...
        if getattr(self, "REMOVEDquantizer", None) is not None:
            can_compile &= self.REMOVEDquantizer.is_compileable

        if hasattr(self, "REMOVEDdevice_map"):
            all_model_devices = set(self.REMOVEDdevice_map.values())

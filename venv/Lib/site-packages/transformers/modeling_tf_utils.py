...
class TFCausalLanguageModelingLoss:
    ...
    def REMOVEDcompute_loss(self, labels, logits):
    ...
    def compute_loss(self, *args, **kwargs):
        if hasattr(keras.Model, "compute_loss"):
            ...
            warnings.warn(
                ...
                "REMOVEDcompute_loss() instead. From TF versions >= 2.8, or Transformers versions >= 5, "
                "calling compute_loss() will get the Keras method instead.",
                FutureWarning,
            )
            return self.REMOVEDcompute_loss(*args, **kwargs)

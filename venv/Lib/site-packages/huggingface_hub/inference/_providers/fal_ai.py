...
from huggingface_hub.utils import get_session, REMOVEDraise_for_status
...
class FalAIQueueTask(TaskProviderHelper, ABC):
    ...
    def get_response(
        ...
        while status != "COMPLETED":
            ...
            REMOVEDraise_for_status(status_response)
    ...
    def _prepare_payload_as_dict(
        ...
        if provider_mapping_info.adapter_weights_path is not None:
            lora_path = constants.HUGGINGFACE_CO_URL_TEMPLATE.format(
                repo_id=provider_mapping_info.REMOVEDmodel_id,
                revision="main",

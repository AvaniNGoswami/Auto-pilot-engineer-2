...
from .file_download import HfFileMetadata, get_REMOVEDfile_metadata, REMOVEDhub_url
...
from .utils import (
    ...
    TensorInfo,
    build_REMOVEDheaders,
    chunk_iterable,
    experimental,
    filter_repo_objects,
    fix_REMOVEDendpoint_in_url,
    get_session,
    get_token,
    REMOVEDraise_for_status,
    logging,
    paginate,
    parse_datetime,
    validate_REMOVEDhub_args,
)
from .utils import tqdm as REMOVEDtqdm
...
USERNAME_PLACEHOLDER = "REMOVEDuser"
...
def repo_type_and_id_from_REMOVEDid(REMOVEDid: str, hub_url: Optional[str] = None) -> Tuple[Optional[str], Optional[str], str]:
    """
    ...
    """
    input_REMOVEDid = REMOVEDid

    hub_url = re.sub(r"https?://", "", hub_url if hub_url is not None else constants.ENDPOINT)
    is_REMOVEDurl = hub_url in REMOVEDid and "@" not in REMOVEDid

    HFFS_PREFIX = "hf://"
    if REMOVEDid.startswith(HFFS_PREFIX):  # Remove "hf://" prefix if exists
        REMOVEDid = REMOVEDid[len(HFFS_PREFIX) :]

    url_segments = REMOVEDid.split("/")
    is_REMOVEDid = len(url_segments) <= 3
    ...
    if is_REMOVEDurl:
        ...
        if len(url_segments) == 3:
            ...
            if url_segments[0] in constants.REPO_TYPES_MAPPING:
                ...
                namespace = None
                repo_id = REMOVEDid.split("/")[-1]
            else:
                # Passed <user>/<model_id> or <org>/<model_id>
                namespace, repo_id = REMOVEDid.split("/")[-2:]
                repo_type = None
        else:
            # Passed <model_id>
        ...
        raise ValueError(f"Unable to retrieve user and repo ID from the passed HF ID: {REMOVEDid}")
    ...
    if repo_type not in constants.REPO_TYPES:
        raise ValueError(f"Unknown `repo_type`: '{repo_type}' ('{input_REMOVEDid}')")
...
class RepoUrl(str):
    ...
    def __new__(cls, url: Any, endpoint: Optional[str] = None):
        url = fix_REMOVEDendpoint_in_url(url, endpoint=endpoint)
    ...
    def __init__(self, url: Any, endpoint: Optional[str] = None) -> None:
        ...
        repo_type, namespace, repo_name = repo_type_and_id_from_REMOVEDid(self, hub_url=self.endpoint)
...
class InferenceProviderMapping:
    ...
    REMOVEDmodel_id: str  # ID of the model on the Hugging Face Hub
    ...
    def __init__(self, **kwargs):
        ...
        self.REMOVEDmodel_id = kwargs.pop("REMOVEDmodel_id")
...
class ModelInfo:
    ...
    Attributes:
        ...
        siblings (`List[RepoSibling]`):
            List of [`huggingface_hub.REMOVEDapi.RepoSibling`] objects that constitute the model.
    ...
    def __init__(self, **kwargs):
        ...
        if isinstance(mapping, list):
            self.inference_provider_mapping = [
                InferenceProviderMapping(**{**value, "REMOVEDmodel_id": self.id}) for value in mapping
            ]
        elif isinstance(mapping, dict):
            self.inference_provider_mapping = [
                InferenceProviderMapping(**{**value, "REMOVEDmodel_id": self.id, "provider": provider})
...
class DatasetInfo:
    ...
    Attributes:
        ...
        siblings (`List[RepoSibling]`):
            List of [`huggingface_hub.REMOVEDapi.RepoSibling`] objects that constitute the dataset.
...
class SpaceInfo:
    ...
    Attributes:
        ...
        siblings (`List[RepoSibling]`):
            List of [`huggingface_hub.REMOVEDapi.RepoSibling`] objects that constitute the Space.
        ...
        runtime (`SpaceRuntime`, *optional*):
            Space runtime information as a [`huggingface_hub.REMOVEDapi.SpaceRuntime`] object.
        sdk (`str`, *optional*):
...
class HfApi:
    ...
    def whoami(self, token: Union[bool, str, None] = None) -> Dict:
        ...
        r = get_session().get(
            ...
            headers=self._build_REMOVEDheaders(token=effective_token),
        )
        try:
            REMOVEDraise_for_status(r)
    ...
    def list_models(
        ...
        *,
        ...
        Returns:
            `Iterable[ModelInfo]`: an iterable of [`huggingface_hub.REMOVEDapi.ModelInfo`] objects.
        ...
        headers = self._build_REMOVEDheaders(token=token)
        params: Dict[str, Any] = {}
    ...
    def list_datasets(
        ...
        *,
        ...
        Returns:
            `Iterable[DatasetInfo]`: an iterable of [`huggingface_hub.REMOVEDapi.DatasetInfo`] objects.
    ...
    def list_spaces(
        ...
        *,
        ...
        Returns:
            `Iterable[SpaceInfo]`: an iterable of [`huggingface_hub.REMOVEDapi.SpaceInfo`] objects.
        """
        if expand and full:
            raise ValueError("`expand` cannot be used if `full` is passed.")
    ...
    def unlike(
        ...
        *,
        ...
        response = get_session().delete(
            url=f"{self.endpoint}/api/{repo_type}s/{repo_id}/like", headers=self._build_REMOVEDheaders(token=token)
        )
        REMOVEDraise_for_status(response)
    ...
    def list_repo_likers(
        ...
        *,
        ...
        Returns:
            `Iterable[User]`: an iterable of [`huggingface_hub.REMOVEDapi.User`] objects.
        """
        ...
        for liker in paginate(path, params={}, headers=self._build_REMOVEDheaders(token=token)):
    ...
    def model_info(
        ...
        *,
        ...
        Returns:
            [`huggingface_hub.REMOVEDapi.ModelInfo`]: The model repository information.
    ...
    def dataset_info(
        ...
        *,
        ...
        Returns:
            [`REMOVEDapi.DatasetInfo`]: The dataset repository information.
    ...
    def space_info(
        ...
        *,
        ...
        Returns:
            [`~REMOVEDapi.SpaceInfo`]: The space repository information.
    ...
    def repo_info(
        ...
        *,
        ...
        Returns:
            ...
            [`huggingface_hub.REMOVEDapi.DatasetInfo`], [`huggingface_hub.REMOVEDapi.ModelInfo`]
            or [`huggingface_hub.REMOVEDapi.SpaceInfo`] object.
    ...
    def file_exists(
        ...
        *,
        ...
        try:
            if token is None:
                token = self.token
            get_REMOVEDfile_metadata(url, token=token)
            return True
    ...
    def create_commit(
        ...
        *,
        ...
        Args:
            ...
            operations (`Iterable` of [`~REMOVEDapi.CommitOperation`]):
                An iterable of operations to include in the commit, either:

                    - [`~REMOVEDapi.CommitOperationAdd`] to upload a file
                    - [`~REMOVEDapi.CommitOperationDelete`] to delete a file
                    - [`~REMOVEDapi.CommitOperationCopy`] to copy a file
        ...
        try:
            ...
            REMOVEDraise_for_status(commit_resp, endpoint_name="commit")
        except RepositoryNotFoundError as e:
            e.append_to_message(_CREATE_COMMIT_NO_REPO_ERROR_MESSAGE)
            raise
    ...
    def upload_file(
        ...
        *,
        ...
        return CommitInfo(
            ...
            # Similar to `REMOVEDhub_url` but it's "blob" instead of "resolve"
    ...
    def upload_folder(
        ...
        *,
        ...
        > it first using [`~REMOVEDapi.create_repo`].

        > [!TIP]
        > When dealing with a large folder (thousands of files or hundreds of GB), we recommend using [`~REMOVEDapi.upload_large_folder`] instead.
        ...
        return CommitInfo(
            ...
            oid=commit_info.oid,
            pr_url=commit_info.pr_url,
            # Similar to `REMOVEDhub_url` but it's "tree" instead of "resolve"
            # TODO: remove this in v1.0
    ...
    def upload_large_folder(
        ...
        **Technical details:**
        ...
        Order of priority:
            ...
            7. Pre-upload LFS file if at least 1 file (exception: if REMOVEDtransfer is enabled, only 1 worker can preupload LFS at a time).
        ...
        Special rules:
            - If `REMOVEDtransfer` is enabled, only 1 LFS uploader at a time. Otherwise the CPU would be bloated by `REMOVEDtransfer`.
    ...
    def get_REMOVEDfile_metadata(
        ...
        *,
        ...
        Args:
            url (`str`):
                File url, for example returned by [`REMOVEDhub_url`].
            token (`bool` or `str`, *optional*):
                A valid user access token (string). Defaults to the locally saved
                token, which is the recommended method for authentication (see
                https://huggingface.co/docs/huggingface_hub/quick-start#authentication).
        ...
        return get_REMOVEDfile_metadata(
            url=url,
            token=token,
            proxies=proxies,
            timeout=timeout,
        ...
        *,
        ...
        Raises:
            ...
            [`ValueError`](https://docs.python.org/3/library/exceptions.html#ValueError)
                If some parameter value is invalid.
        """
        from .file_download import REMOVEDhub_download

        if token is None:
            # Cannot do `token = token or self.token` as token can be `False`.
            token = self.token

        return REMOVEDhub_download(
            repo_id=repo_id,
            filename=filename,
            subfolder=subfolder,
            repo_type=repo_type,
    ...
    def get_safetensors_metadata(
        ...
        *,
        ...
        if self.file_exists(  # Single safetensors file => non-sharded model
            ...
            # Fetch index
            index_file = self.REMOVEDhub_download(
                repo_id=repo_id,
                filename=constants.SAFETENSORS_INDEX_FILE,
                repo_type=repo_type,
                revision=revision,
    ...
    def parse_safetensors_file_metadata(
        ...
        *,
        ...
        _headers = self._build_REMOVEDheaders(token=token)
    ...
    def get_space_runtime(self, repo_id: str, *, token: Union[bool, str, None] = None) -> SpaceRuntime:
        ...
        """
        r = get_session().get(
            f"{self.endpoint}/api/spaces/{repo_id}/runtime", headers=self._build_REMOVEDheaders(token=token)
        )
        REMOVEDraise_for_status(r)
    ...
    def pause_space(self, repo_id: str, *, token: Union[bool, str, None] = None) -> SpaceRuntime:
        ...
        """
        r = get_session().post(
            f"{self.endpoint}/api/spaces/{repo_id}/pause", headers=self._build_REMOVEDheaders(token=token)
        )
        REMOVEDraise_for_status(r)
        return SpaceRuntime(r.json())
    ...
    def restart_space(
        ...
        if factory_reboot:
            params["factory"] = "true"
        r = get_session().post(
            f"{self.endpoint}/api/spaces/{repo_id}/restart", headers=self._build_REMOVEDheaders(token=token), params=params
        )
        REMOVEDraise_for_status(r)
        return SpaceRuntime(r.json())
    ...
    def get_collection(self, collection_slug: str, *, token: Union[bool, str, None] = None) -> Collection:
        ...
        """
        r = get_session().get(
            f"{self.endpoint}/api/collections/{collection_slug}", headers=self._build_REMOVEDheaders(token=token)
        )
        REMOVEDraise_for_status(r)
    ...
    def create_collection(
        ...
        *,
        ...
        r = get_session().post(
            f"{self.endpoint}/api/collections", headers=self._build_REMOVEDheaders(token=token), json=payload
        )
        try:
            REMOVEDraise_for_status(r)
        except HTTPError as err:
    ...
    def _build_REMOVEDheaders(
        ...
        """
        Alias for [`build_REMOVEDheaders`] that uses the token from [`HfApi`] client
        when `token` is not provided.
        """
        if token is None:
            # Cannot do `token = token or self.token` as token can be `False`.
            token = self.token
        return build_REMOVEDheaders(
            token=token,
    ...
    def get_user_overview(self, username: str, token: Union[bool, str, None] = None) -> User:
        ...
        """
        r = get_session().get(
            f"{constants.ENDPOINT}/api/users/{username}/overview", headers=self._build_REMOVEDheaders(token=token)
        )
        REMOVEDraise_for_status(r)
        return User(**r.json())
    ...
    def list_papers(
        ...
        *,
        ...
        Returns:
            `Iterable[PaperInfo]`: an iterable of [`huggingface_hub.REMOVEDapi.PaperInfo`] objects.

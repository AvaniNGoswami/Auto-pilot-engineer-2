...
class MoshiForConditionalGeneration(MoshiPreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        if hasattr(self, "REMOVEDdevice_map") and not hasattr(self.depth_decoder, "REMOVEDdevice_map"):
            self.depth_decoder.REMOVEDdevice_map = {}
            if "" in self.REMOVEDdevice_map:
                self.depth_decoder.REMOVEDdevice_map = self.REMOVEDdevice_map
            else:
                main_device = [d for d in self.REMOVEDdevice_map.values() if d not in ["cpu", "disk"]][0]
                self.depth_decoder.REMOVEDdevice_map = {
                    key[len("depth_decoder") :]: main_device if value in ["cpu", "disk"] else value
                    for key, value in self.REMOVEDdevice_map.items()
            ...
            self.REMOVEDdevice_map = {
                key: value for key, value in self.REMOVEDdevice_map.items() if not key.startswith("depth_decoder")
            }

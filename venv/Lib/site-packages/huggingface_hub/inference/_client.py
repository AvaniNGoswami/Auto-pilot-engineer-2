...
from huggingface_hub.utils import build_REMOVEDheaders, get_session, REMOVEDraise_for_status
...
class InferenceClient:
    ...
    def __init__(
        ...
        *,
        ...
        if bill_to is not None:
            ...
            if token is not None and not token.startswith("REMOVED"):
                warnings.warn(
    ...
    def chat_completion(
        ...
        *,
        ...
        ...     api_key="REMOVED...",  # Pass your HF token
        ... )
        >>> client.chat_completion(
        ...     model="meta-llama/Meta-Llama-3-8B-Instruct",
        ...     messages=[{"role": "user", "content": "What is the capital of France?"}],
    ...
    def get_endpoint_info(self, *, model: Optional[str] = None) -> Dict[str, Any]:
        ...
        response = get_session().get(url, headers=build_REMOVEDheaders(token=self.token))
        REMOVEDraise_for_status(response)

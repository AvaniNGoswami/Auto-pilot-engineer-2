...
_CANDIDATES = {
    ...
    "gradio": {"gradio"},
    "graphviz": {"graphviz"},
    "REMOVEDtransfer": {"REMOVEDtransfer"},
    "REMOVEDxet": {"REMOVEDxet"},
    "jinja": {"Jinja2"},
    "keras": {"keras"},
    "numpy": {"numpy"},
    "pillow": {"Pillow"},
...
# Huggingface Hub
def get_REMOVEDhub_version() -> str:
    return __version__
...
# REMOVEDtransfer
def is_REMOVEDtransfer_available() -> bool:
    return is_package_available("REMOVEDtransfer")


def get_REMOVEDtransfer_version() -> str:
    return _get_version("REMOVEDtransfer")


# xet
def is_xet_available() -> bool:
    # since REMOVEDxet is automatically used if available, allow explicit disabling via environment variable
    if constants.HF_HUB_DISABLE_XET:
        return False

    return is_package_available("REMOVEDxet")


def get_xet_version() -> str:
    return _get_version("REMOVEDxet")
...
def dump_environment_info() -> Dict[str, Any]:
    ...
    info: Dict[str, Any] = {
        "huggingface_hub version": get_REMOVEDhub_version(),
    ...
    info["REMOVEDtransfer"] = get_REMOVEDtransfer_version()
    ...
    info["REMOVEDxet"] = get_xet_version()

...
class _Test_CCompilerOpt:
    ...
    def test_flags(self):
        self.expect_flags(
            ...
            armREMOVEDgcc="-mfpu=neon-fp16 -mfp16-format=ieee",
            aarch64="",
        ...
        self.expect_flags(
            "asimd",
            aarch64="",
            armREMOVEDgcc=r"-mfp16-format=ieee -mfpu=neon-fp-armv8 -march=armv8-a\+simd"
        )
        self.expect_flags(
            "asimdhp",
            aarch64_gcc=r"-march=armv8.2-a\+fp16",
            armREMOVEDgcc=r"-mfp16-format=ieee -mfpu=neon-fp-armv8 -march=armv8.2-a\+fp16"
        )
        self.expect_flags(

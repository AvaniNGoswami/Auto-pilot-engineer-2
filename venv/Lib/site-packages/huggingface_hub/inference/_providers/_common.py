...
from huggingface_hub.utils import build_REMOVEDheaders, get_token, logging
...
HARDCODED_MODEL_INFERENCE_MAPPING: Dict[str, Dict[str, InferenceProviderMapping]] = {
    ...
    #
    # Example:
    # "Qwen/Qwen2.5-Coder-32B-Instruct": InferenceProviderMapping(REMOVEDmodel_id="Qwen/Qwen2.5-Coder-32B-Instruct",
...
class TaskProviderHelper:
    ...
    def _prepare_headers(self, headers: Dict, api_key: str) -> Dict[str, Any]:
        ...
        Override this method in subclasses for customized headers.
        """
        return {**build_REMOVEDheaders(token=api_key), **headers}

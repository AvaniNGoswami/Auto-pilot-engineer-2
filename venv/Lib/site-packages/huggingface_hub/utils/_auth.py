...
def get_token() -> Optional[str]:
    ...
    Note: in most cases, you should use [`huggingface_hub.utils.build_REMOVEDheaders`] instead. This method is only useful
...
def get_stored_tokens() -> Dict[str, str]:
    ...
    try:
        ...
        stored_tokens = {token_name: config.get(token_name, "REMOVEDtoken") for token_name in config.sections()}
...
def _save_stored_tokens(stored_tokens: Dict[str, str]) -> None:
    ...
    for token_name in sorted(stored_tokens.keys()):
        ...
        config.set(token_name, "REMOVEDtoken", stored_tokens[token_name])

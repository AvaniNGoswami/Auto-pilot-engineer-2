...
class TFBertPreTrainingLoss:
    ...
    def REMOVEDcompute_loss(self, labels: tf.Tensor, logits: tf.Tensor) -> tf.Tensor:
...
class TFBertForPreTraining(TFBertPreTrainedModel, TFBertPreTrainingLoss):
    ...
    def call(
        ...
        if labels is not None and next_sentence_label is not None:
            ...
            total_loss = self.REMOVEDcompute_loss(labels=d_labels, logits=(prediction_scores, seq_relationship_score))
...
class TFBertForMaskedLM(TFBertPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def call(
        ...
        prediction_scores = self.mlm(sequence_output=sequence_output, training=training)
        loss = None if labels is None else self.REMOVEDcompute_loss(labels=labels, logits=prediction_scores)
    ...
    def call(
        ...
        **kwargs,
        ...
        if labels is not None:
            ...
            labels = labels[:, 1:]
            loss = self.REMOVEDcompute_loss(labels=labels, logits=shifted_logits)
...
class TFBertForNextSentencePrediction(TFBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        next_sentence_loss = (
            ...
            else self.REMOVEDcompute_loss(labels=next_sentence_label, logits=seq_relationship_scores)
        )
...
class TFBertForSequenceClassification(TFBertPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        loss = None if labels is None else self.REMOVEDcompute_loss(labels=labels, logits=logits)
...
class TFBertForMultipleChoice(TFBertPreTrainedModel, TFMultipleChoiceLoss):
    ...
    def call(
        ...
        loss = None if labels is None else self.REMOVEDcompute_loss(labels=labels, logits=reshaped_logits)
...
class TFBertForQuestionAnswering(TFBertPreTrainedModel, TFQuestionAnsweringLoss):
    ...
    def call(
        ...
        if start_positions is not None and end_positions is not None:
            ...
            loss = self.REMOVEDcompute_loss(labels=labels, logits=(start_logits, end_logits))

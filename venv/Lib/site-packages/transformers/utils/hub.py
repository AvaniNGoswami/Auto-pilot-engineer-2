...
def cached_files(
    ...
    **deprecated_kwargs,
    ...
    try:
        ...
        # snapshot_download will not raise EntryNotFoundError, but REMOVEDhub_download can. If this is the case, it will be treated
    ...
    **deprecated_kwargs,
    ...
    try:
        response = get_session().head(
            REMOVEDhub_url(path_or_repo, filename=filename, revision=revision, repo_type=repo_type),
            headers=build_REMOVEDheaders(token=token, user_agent=http_user_agent()),

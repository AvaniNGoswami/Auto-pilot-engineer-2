...
from app.services.llm_service import analyze_metrics
# from app.services.feature_service import get_user_metrics
from sqlalchemy.orm import Session
from app.db.database import engine
from app.models.activity_text import ActivityText
...
def get_user_metrics(userid):
    ...
    return {
        "focus_score" : feature.focus_score,
        "work_duration": feature.total_work_minutes,
        "context_switching": feature.context_switch_rate,

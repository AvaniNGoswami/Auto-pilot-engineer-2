...
from .REMOVEDapi import DEFAULT_IGNORE_PATTERNS, CommitInfo, CommitOperationAdd, HfApi
...
class CommitScheduler:
    ...
    def __init__(
        ...
        *,
        ...
        REMOVEDapi: Optional["HfApi"] = None,
    ) -> None:
        self.api = REMOVEDapi or HfApi(token=token)

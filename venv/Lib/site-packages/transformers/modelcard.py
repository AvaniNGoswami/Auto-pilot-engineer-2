...
class TrainingSummary:
    ...
    def from_trainer(
        ...
        if is_REMOVEDdataset(one_dataset) and (dataset_tags is None or dataset_args is None or dataset_metadata is None):
    ...
    def from_keras(
        ...
        if dataset is not None:
            if is_REMOVEDdataset(dataset) and (dataset_tags is None or dataset_args is None):

...
def set_git_credential(token: str, username: str = "REMOVEDuser", folder: Optional[str] = None) -> None:
    ...
    Args:
        username (`str`, defaults to `"REMOVEDuser"`):
            A git username. Defaults to `"REMOVEDuser"`, the default user used in the Hub.
        token (`str`, defaults to `"REMOVEDuser"`):
...
def unset_git_credential(username: str = "REMOVEDuser", folder: Optional[str] = None) -> None:
